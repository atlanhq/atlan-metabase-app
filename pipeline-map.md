...
Generated from: `marketplace-packages/packages/atlan/metabase/templates/default.yaml`
...
Reason: `templateRef: rest-api / oauth2-client-credentials` — framework credential fetching via Heracles service. No implementation needed; the app handles credentials via its own Temporal activity configuration.
